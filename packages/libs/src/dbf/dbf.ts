...
import { mergeUint8Arrays } from "../array.ts";
...
export class DBF {
   ...
   */
  constructor(public fields: Field[], public records?: RecordValue[]) {
  ...
  get header(): Uint8Array {
    ...
    return mergeUint8Arrays([header_define, record_define, RECORD_END]);
  }
